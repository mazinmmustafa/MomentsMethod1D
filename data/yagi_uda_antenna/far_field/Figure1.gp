...
plot 'data1.dat' using (pi/2-$1):($2 > r_min ? $2 : r_min) with lines lw 2 dt 1 lc 'blue' title 'Elevation', \
     'data2.dat' using (-$1):($2 > r_min ? $2 : r_min) with lines lw 2 dt 1 lc 'red' title 'Azimuth'
