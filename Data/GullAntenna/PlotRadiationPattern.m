...
PolardB(Data(:,2)*pi/180,10*log10(sigmaTheta),[-25 0],6,'-k')
title('$|E_{\varphi}|$ [dB], $\theta=\pi/2$',...
...
PolardB(Data(:,4)*pi/180,10*log10(sigmaPhi),[-25 0],6,'-k')
title('$|E_{\varphi}|$ [dB], $\varphi=0$','Interpret','Latex','FontSize',15)
%%
