close all; clear; clc;
%%
Data    =   load('DataElevation.dat');
figure()
PolardB(Data(:,1)-pi/2,20*log10(Data(:,2)),[-40 0],5,'-k')
hold on
PolardB(Data(:,3),20*log10(Data(:,4)),[-40 0],5,'--k')
hold off
...
legend('Elevation','Azimuth','Interpreter','Latex','Location','NorthWest')
set(gca,'FontSize',13)
%%
